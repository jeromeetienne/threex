...
THREEx.NoiseShaderMaterial	= function(){	
	var material	= new THREE.ShaderMaterial( {
		...
		vertexShader	: THREEx.NoiseShaderMaterial.vertexText,
		fragmentShader	: THREEx.NoiseShaderMaterial.fragmentText,
	}); 
	return material
}

THREEx.NoiseShaderMaterial.fragmentText	= [
'	//',
...
THREEx.NoiseShaderMaterial.vertexText	= [
'	varying vec2 vUv;',
'	uniform vec2 scale;',
'	uniform vec2 offset;',
'',
