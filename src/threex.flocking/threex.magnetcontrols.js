...
THREEx.MagnetControls	= function(object3d){
	...
	function computeInteraction(controls1, controls2){
		...
		var intensity	= THREEx.MagnetControls.Easing.Cubic.In(1-proximity)*0.5
	...
	this.computeForces	= function(delta, others, startIdx){
		for(var i = startIdx; i < others.length; i++){
			var other	= others[i]
			computeInteraction(this, others[i], delta)
		}
	}
